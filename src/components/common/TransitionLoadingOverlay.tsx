...
const TransitionLoadingOverlay = ({ title }: TransitionLoadingOverlayProps) => (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-5">
        <div
            className="border-line flex min-h-64 w-full max-w-180 flex-col items-center justify-center rounded-[5px] border bg-white px-6 py-10 shadow-[5px_7px_2px_rgba(231,226,216,0.85)]"
            role="status"
            aria-live="polite"
        >
