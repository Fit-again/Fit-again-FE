...
export const UPCYCLE_PRODUCTS: UpcycleProduct[] = [
    {
        id: "card-wallet",
        label: "카드지갑",
        description:
...
export const UPCYCLE_REASONING = [
    {
        painPoint: "무게가 부담스러워요",
        direction:
            "전체 크기를 필요한 소지품만 휴대할 수 있는 형태로 전환해요.",
    },
    {
        painPoint: "스트랩이 자꾸 흘러내려요",
        direction: "크로스바디 형태로 변경해 착용 안정성을 높여요.",
    },
    {
        painPoint: "큰 수납공간을 자주 사용하지 않아요",
        direction: "현재 사용량에 맞는 컴팩트한 수납 구조로 재탄생해요.",
    },
] as const;
